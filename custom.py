...
ROOT_DIR = r"C:\workpc\Code\Object_det\Aarohi\Mask rcnn\mrcnn"
...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 2 + 3  # Background + phone,laptop and mobile
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        annotations1 = json.load(open('C:\workpc\Code\Object_det\Aarohi\Mask rcnn\dataset\train\ia_project.json'))
        # print(annotations1)
